...
export default function CommentReplies({commentPath, SpamSheild, predefinedWords}) {
  ...
  const handleAddReply = async () => {
    ...
    if (predefinedWords) {
      ...
      if (toxicWordsFound.length > 0) {
        const message = `Your comment contains inappropriate language: ${toxicWordsFound.join(', ')}. Please keep the conversation respectful.`;
